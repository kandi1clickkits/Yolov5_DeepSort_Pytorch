...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/Yolov5_DeepSort_Pytorch/releases/download/v1.0.0/Yolov5_DeepSort_Pytorch.zip
SET REPO_DEPENDENCIES_URL=https://raw.githubusercontent.com/kandi1clickkits/Yolov5_DeepSort_Pytorch/main/requirements.txt
SET REPO_NAME=Yolov5_DeepSort_Pytorch.zip
SET EXTRACTED_REPO_DIR=Yolov5_DeepSort_Pytorch
SET NOTEBOOK_NAME=YOLOV5_DEEPSORT_NOTEBOOK.ipynb
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
